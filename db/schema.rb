...
ActiveRecord::Schema.define(version: 20171222092824) do
  ...
  add_index "mesages", ["conversation_id"], name: "index_mesages_on_conversation_id"
  add_index "mesages", ["user_id"], name: "index_mesages_on_user_id"
